export default function FooterSection() {
  return (
    <div className="w-full pt-10 flex flex-col justify-start items-start">
      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans">NETenergy</div>
          </div>
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          {/* Applications Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-[rgba(73,66,61,0.50)] text-sm font-medium leading-5 font-sans">Applications</div>
      ...
      <div className="self-stretch px-4 md:px-8 pb-6">
        <div className="text-[#49423D] text-sm font-normal leading-5 font-sans">
          <div className="mb-2">
            <strong>Contact:</strong> said@netenergytes.com
          </div>
          <div>
            <strong>Website:</strong> www.netenergytes.com
          </div>
        </div>
      </div>
